...
def view_detail(compound: str, block: str):
    ...
    return render_template("view_detail.html.j2", compound=obj.compound, block=obj.name, obj=obj)
...
def view_diagram(compound: str, block: str):
    ...
    return render_template("view_diagram.html.j2", obj=obj, depth=depth)
